...
class SearchFinanceScreen extends StatefulWidget {
  SearchFinanceScreen({this.userImage});
  final userImage;
  @override
  _SearchFinanceScreenState createState() => _SearchFinanceScreenState();
}

class _SearchFinanceScreenState extends State<SearchFinanceScreen> {
  @override
        ...
        child: ListView(
          ...
          children: <Widget>[
            RoundedImageWidget(
              ...
              pageTitle: 'Search Finance/Factoring',
              pageDesc: 'Find The Best Invoice Factoring Company or Business Loan for Trucking Company .',
            ),
            Padding(
