...
class SearchReapirAndServicesScreen extends StatefulWidget {
  SearchReapirAndServicesScreen({this.userImage});
  final userImage;
  @override
  _SearchReapirAndServicesScreenState createState() => _SearchReapirAndServicesScreenState();
}

class _SearchReapirAndServicesScreenState extends State<SearchReapirAndServicesScreen> {
  @override
        ...
        child: ListView(
          ...
          children: <Widget>[
            RoundedImageWidget(
              ...
              appBarLabel: 'Repair & Services',
              imageUrl: widget.userImage,
              pageLogoImage: 'assets/repeair_services.svg',
              pageTitle: 'Search Repair & Services',
              pageDesc: 'Find Professional Services',
            ),
            Padding(
