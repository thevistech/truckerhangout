...
class SearchQuestionAnswerScreen extends StatefulWidget {
  SearchQuestionAnswerScreen({this.userImage});
  final userImage;
  @override
  _SearchQuestionAnswerScreenState createState() => _SearchQuestionAnswerScreenState();
}

class _SearchQuestionAnswerScreenState extends State<SearchQuestionAnswerScreen> {
  @override
        ...
        child: ListView(
          ...
          children: <Widget>[
            RoundedImageWidget(
              ...
              appBarLabel: 'Question/Answer',
              imageUrl: widget.userImage,
              pageLogoImage: 'assets/question_answer_servicce.svg',
              pageTitle: 'Search Question/Answers',
              pageDesc: 'Find the Answer of your question',
            ),
            Padding(
