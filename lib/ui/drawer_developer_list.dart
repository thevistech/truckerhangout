...
import 'package:flutterapp/utills/app_bar_for_drawer_with_search.dart';
...
class DeveloperList extends StatefulWidget {
  ...
  DeveloperList({this.dashBoardMainStore, this.currentUserImage});
  @override
  _SelectDeveloperState createState() => _SelectDeveloperState();
}

class _SelectDeveloperState extends State<DeveloperList> {
  @override
  void initState() {
    // if (!widget.dashBoardMainStore.isDeveloperListLoaded) {
    widget.dashBoardMainStore.pageNumber = 1;
    widget.dashBoardMainStore
        .getAllDeveloperData(context, widget.dashBoardMainStore.pageNumber, "")
        .then((value) {
