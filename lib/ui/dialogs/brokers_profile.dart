...
class RcustomDialog extends StatelessWidget {
  ...
  RcustomDialog({this.brokersList, this.profilePicUrl});
...
class ContainerWithCircle extends StatefulWidget {
  Datum brokersList;
  String profilePicUrl;
  ContainerWithCircle({this.brokersList, this.profilePicUrl});
        ...
        children: <Widget>[
          Padding(
            ...
            child: Container(
              ...
              color: Colors.white,
              height: ifPieChartIsEmpty ? 325 : 475.0,
              child:
              Column(
                children: <Widget>[
                  Container(
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Container(
                        padding: EdgeInsets.all(5.0),
                        child: Text(
                          "${widget.brokersList.companyName}",
                          style: TextStyle(fontWeight: FontWeight.bold),
                        ),
                      ),
                      widget.brokersList.companyVerificationStatus == "Verified"
                          ? Icon(
                              Icons.verified_user,
                              size: 15,
                              color: colorMain,
                    ...
                    children: <Widget>[
                      Container(
                        child: IconTheme(
                          ...
                          child: StarDisplay(
                              value: int.tryParse(
                                  "${widget.brokersList.average_rating}")),
                        ),
                      ),
                      Container(
                        padding: EdgeInsets.all(5.0),
                        child: Text(
                          "(${widget.brokersList.average_rating} Reviews)",
                          style: TextStyle(),
                        ),
                      ),
                    ],
