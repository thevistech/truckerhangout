...
// const LatLng widget.destLocation = LatLng(42.6871386, -71.2143403);

class GoogleMapDirection extends StatefulWidget {
  LatLng sourceLocation, destLocation;
  GoogleMapDirection({this.sourceLocation, this.destLocation});
  @override
  _GoogleMapDirectionState createState() => _GoogleMapDirectionState();
}
...
class _GoogleMapDirectionState extends State<GoogleMapDirection> {
  ...
  String googleAPIKey = "AIzaSyDU71H0LIcon2F2zptu3JRv6NatApjNvIU";
  // for my custom icons
