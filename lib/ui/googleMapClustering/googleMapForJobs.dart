...
class MapJob extends StatefulWidget {
  ...
  MapJob({this.jobsModel, this.items});
  @override
  State<MapJob> createState() => MapSampleState();
}

class MapSampleState extends State<MapJob> {
    ...
    return Align(
      ...
      child: AnimatedContainer(
          ...
          child: PageView.builder(
              ...
              itemCount: widget.jobsModel.data.length,
              scrollDirection: Axis.horizontal,
              itemBuilder: (ctx, int) {
                var data = widget.jobsModel.data[int];
                      ...
                      children: <Widget>[
                        ClipRRect(
                          ...
                          child: CachedNetworkImage(
                              ...
                              width: MediaQuery.of(context).size.width,
                              height: 150,
                              imageUrl: widget.jobsModel.url +
                                  widget.jobsModel.data[int].info.thumbnail,
        ...
        return Marker(
          ...
          onTap: () {
            ...
            if (!cluster.isMultiple) {
              ...
              for (int i = 0; i < widget.jobsModel.data.length; i++) {
                if (widget.jobsModel.data[i].address[0].id == markerID) {
