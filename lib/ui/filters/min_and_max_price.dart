...
class MinAndMaxPrice extends StatefulWidget {
  final DashBoardMainStore dashboardStore;
  MinAndMaxPrice({this.dashboardStore});
  MinAndMaxPriceState createState() => MinAndMaxPriceState();
}

class MinAndMaxPriceState extends State<MinAndMaxPrice>
  ...
  void initState() {
    ...
    _selectedMin = 0;
    _selectedMax = 0;
    _minValues = widget.dashboardStore.filterPropertyModel.data.minPrices;
    _maxValues = widget.dashboardStore.filterPropertyModel.data.maxPrices;
  }
      ...
      children: <Widget>[
        Expanded(
          child: Container(
            ...
            child: RaisedButton(
              onPressed: () {
                widget.dashboardStore.moreFilterMinPrice = "0";
                widget.dashboardStore.moreFilterMaxPrice = "Any";
                _selectedMax = 0;
                _selectedMin = 0;
                setState(() {});
              },
