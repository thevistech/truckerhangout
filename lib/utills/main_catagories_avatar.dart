...
class MainCatagoriesAvatarWidget extends StatelessWidget {
  final Datum user;
  ...
  const MainCatagoriesAvatarWidget({
    @required this.user,
    this.onTap,
    ...
    final avatar = Column(
      ...
      children: <Widget>[
        Container(
          height: radius * 2 + 9.0,
          width: radius * 2 + 9.0,
          decoration: user == null ? null : _gradientBorderDecoration,
          child: Stack(
            ...
            children: <Widget>[
              Container(
                ...
                child: Container(
                  ...
                  child: CircleAvatar(
                    radius: radius,
                    backgroundImage: NetworkImage(store.brokersList.url + "" + user.picture),
                  ),
                ),
              ),
