...
const nickwu241 =
    User(name: 'nickwu241', imageUrl: 'assets/news_and_info_demo_image.png');
const grootlover = User(
    name: 'groot',
    imageUrl: 'assets/blueimg.png',
    stories: placeholderStories);
const starlord = User(
    name: 'starlord',
    imageUrl: 'assets/bhariaimg.png',
    stories: placeholderStories);
const gamora = User(
    name: 'gamora',
...
const rocket = User(
    name: 'rocket',
    imageUrl: 'assets/news_and_info_demo_image.png',
    stories: placeholderStories);
const nebula = User(
    name: 'nebula',
